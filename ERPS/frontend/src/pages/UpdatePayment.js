...
export default function UpdatePayment() {
  ...
  async function sendData(e) {
    ...
    if (!paymentID.trim()) {
      ...
      await fetch(
        `http://localhost:3000/api/payments/updatePayment/${params.id}`,
        {
          method: 'post',
          ...
          >
            <div className='form-group'>
              ...
              <input
                ...
                id='paymentID'
                placeholder='Enter correct Payment ID'
                onChange={(e) => {
            ...
            <div className='form-group'>
              ...
              <input
                ...
                placeholder='Enter correct Payment Description'
                onChange={(e) => {
            ...
            <div className='form-group'>
              ...
              <input
                ...
                className='form-control'
                id='category'
                placeholder='Enter correct Payment Category'
                onChange={(e) => {
            ...
            <div className='form-group'>
              ...
              <input
                ...
                className='form-control'
                id='date'
                placeholder='Enter correct Payment Date'
                onChange={(e) => {
            ...
            <div className='form-group'>
              ...
              <input
                ...
                className='form-control'
                id='amount'
                placeholder='Enter correct Payment Amount'
                onChange={(e) => {
