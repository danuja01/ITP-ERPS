  ...
  return (
    <section className='flex gap-6'>
      ...
      <div className='w-full mr-12'>
        <AdminName />
        <br></br>
        <h1 className='text-2xl font-bold text-gray-900 justify-start flex'> ADMIN DASHBOARD </h1>
        <br></br><br></br>
        <h4 class="text-2xl font-bold text-gray-900 justify-start flex" style={{ paddingLeft: "550px" }}>---Avaliable facilities List---</h4>
        <br></br><br></br>
            ...
            <div class="block rounded-lg shadow-lg bg-white max-w-sm text-center">
              ...
              <div class="p-6">
                <p class="text-gray-700 text-base mb-4">
                  Includes all the Avaliable degree lists
                </p>
              
              </div>
              <div class="py-3 px-6 border-t border-gray-300 text-white dark:bg-[#4F310E]">
                updated on date
              </div>
            </div>
          </div></div>
