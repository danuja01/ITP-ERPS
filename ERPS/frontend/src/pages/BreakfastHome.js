...
export default function BreakfastHome() {
    ...
    return (
        ...
        <section><div>
            ...
            <div>
                <div class="pl-10"><h1 style={{ fontSize: "32px", fontFamily: "lusida sans unicord" }}>BREAKFAST</h1></div>
            </div>
            <br></br>
            <br></br>
                                    ...
                                    <form onSubmit={sendData} >
                                        ...
                                        <div class="px-5 pb-5">
                                            <a href="#">
                                                ...
                                                ><br></br> {FoodItem.name}</h5>
                                            </a>
                                            <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white" onLoadStart={() => setName(FoodItem.name)}><br></br> {FoodItem.description}</h5>
