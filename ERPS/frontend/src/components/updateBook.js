...
import AdminNav from "../components/AdminNav"
  ...
  <br/><br/>
            <form  className="formalign" onSubmit={(e) => {
                e.preventDefault();
            ...
            const newBook = {
                ...
                axios.put("http://localhost:4000/book/update/"+id, newBook)
                .then(() => {
                    alert("Book Updated");
                })
                .catch((err) => {
        ...
        <div class="form">
            <div class="title">Update Book Details</div>
               ...
               <div className="input-container ic1">
                ...
                <input value={ISBN_Number} type="number"  className="input"  minLength={13} maxLength={13} onChange={(e) => {
            ...
            <div className="input-container ic2">
                ...
                <input type="text" value={Book_Name} className="input" id="Book_Name"  onChange={(e)=>{
            ...
            <div className="input-container ic2">
                ...
                <input type="text" value={Author_Name} className="input" id="Author_Name"  onChange={(e)=>{
            ...
            <div className="input-container ic2">
                ...
                <input type="text"  value={Location} className="input" id="Location"  onChange={(e)=>{
            ...
            <div className="input-container ic2">
                ...
                <input type="number"  value={Copies} className="input" id="Copies"  onChange={(e)=>{
                    setCopies(e.target.value);
                }}/>
                     <div class="cut"></div>
                <label for="Copies" class="placeholder">Copies</label>
            </div>
<br/>
